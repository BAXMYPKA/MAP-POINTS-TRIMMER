...
//		System.out.println(processedKml);
	...
	@Test
	public void locusAsAttachment_With_2_Placemarks_Should_Add_More_Attachments_Src_From_Description_To_Each_Without_Duplicates()
			throws IOException, TransformerException, SAXException, ParserConfigurationException, InterruptedException {
	...
	@Test
	public void clearOutdatedDescriptions_Should_Replace_Newer_Timestamp_From_Description()
			throws IOException, ParserConfigurationException, SAXException, TransformerException, InterruptedException {
		//GIVEN
		String descriptionWithOlderDate = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
				"<kml xmlns=\"http://www.opengis.net/kml/2.2\" xmlns:gx=\"http://www.google.com/kml/ext/2.2\"\n" +
				...
				"\t</Point>\n" +
				"\t<gx:TimeStamp>\n" +
				"\t\t<when>2012-08-21T00:27:31Z</when>\n" +
				"\t</gx:TimeStamp>\n" +
				"</Placemark>\n" +
				"</Document>\n" +
				"</kml>\n";
	...
	@Test
	public void clearOutdatedDescriptions_Should_Retain_Table_Rows_And_Data_With_Content_If_No_Creation_Date_Presented_In_Description()
			throws IOException, ParserConfigurationException, SAXException, TransformerException, InterruptedException {
		//GIVEN
		...
		assertAll(
				() -> assertTrue(processedKml.contains(
						"<tr> \n" +
								"   <td align=\"left\" valign=\"center\"><small><b>Высота</b></small></td> \n" +
								"   <td align=\"center\" valign=\"center\">154 m</td> \n" +
								"  </tr>")),
				() -> assertTrue(processedKml.contains(
						"<tr> \n" +
								"   <td align=\"left\" valign=\"center\"><small><b>Азимут</b></small></td> \n" +
								"   <td align=\"center\" valign=\"center\">303°</td> \n" +
								"  </tr>")),
				() -> assertTrue(processedKml.contains(
						"<tr> \n" +
								"   <td align=\"left\" valign=\"center\"><small><b>Точность</b></small></td> \n" +
	...
	@Test
	public void clearOutdatedDescriptions_Should_Retain_Table_Rows_And_Data_With_Content_If_No_Creation_Date_Presented_In_When_TimeStamp()
			throws IOException, ParserConfigurationException, SAXException, TransformerException, InterruptedException {
		//GIVEN
		String descriptionWithoutDate = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
				"<kml xmlns=\"http://www.opengis.net/kml/2.2\" xmlns:gx=\"http://www.google.com/kml/ext/2.2\"\n" +
