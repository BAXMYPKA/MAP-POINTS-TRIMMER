...
class LocusIconsHandler {
	 ...
	 * 1) {@link #isLocusPhotoId(String)} So the basic match of 'Style id=""' has to start with 'file:///',
	 * contain a Locus-autogenerated part of a full path like '/Locus/cache/images/'
