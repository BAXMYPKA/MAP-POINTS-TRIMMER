...
Фотографиям можно сделать правильный предпросмотр, удалить ненужную историю сохранений, выставить любой путь до них, удалить устаревшие данные из описаний и т.п. Также при экспорте в Google Earth есть опции настройки размера, цвета и прозрачности иконок и текста при отображении их на спутниковой карте.
